#### PREPARATION DATA ####
setwd("~/Universit�/Master/M1/Stage/raman_omics/R")
data_expr=read.table("/Users/lilly/Documents/Universit�/Master/M1/Stage/raman_omics/R/Data/expr_gene.csv",header=T,row.names=1,sep=",",dec=",")
data2_data_expr=t(data_expr) #create a new matrix

data_raman=read.table("/Users/lilly/Documents/Universit�/Master/M1/Stage/raman_omics/R/Data/raman_data.csv",header=T,sep=",",dec=",")
